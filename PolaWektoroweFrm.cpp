...
void PolaWektoroweFrm::CreateGUIControls()
{
	...
	WxToggleButton1 = new wxToggleButton(this, ID_WXTOGGLEBUTTON1, _("1"), wxPoint(10, 20), wxSize(28, 29), 0, wxDefaultValidator, _("WxToggleButton1"));
	WxStaticBoxSizer1->Add(WxToggleButton1, 0, wxALIGN_CENTER | wxALL, 5);

	WxToggleButton2 = new wxToggleButton(this, ID_WXTOGGLEBUTTON2, _("2"), wxPoint(48, 20), wxSize(29, 29), 0, wxDefaultValidator, _("WxToggleButton2"));
	WxStaticBoxSizer1->Add(WxToggleButton2, 0, wxALIGN_CENTER | wxALL, 5);

	WxToggleButton3 = new wxToggleButton(this, ID_WXTOGGLEBUTTON3, _("3"), wxPoint(87, 20), wxSize(29, 29), 0, wxDefaultValidator, _("WxToggleButton3"));
	...
	WxEdit1 = new wxTextCtrl(this, ID_WXEDIT1, _("WxEdit1"), wxPoint(30, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit1"));
	...
	WxEdit2 = new wxTextCtrl(this, ID_WXEDIT2, _("WxEdit2"), wxPoint(118, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit2"));
	...
	WxEdit3 = new wxTextCtrl(this, ID_WXEDIT3, _("WxEdit3"), wxPoint(205, 5), wxSize(51, 22), 0, wxDefaultValidator, _("WxEdit3"));
	...
	WxEdit4 = new wxTextCtrl(this, ID_WXEDIT4, _("WxEdit4"), wxPoint(30, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit4"));
	...
	WxEdit5 = new wxTextCtrl(this, ID_WXEDIT5, _("WxEdit5"), wxPoint(118, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit5"));
	...
	WxEdit6 = new wxTextCtrl(this, ID_WXEDIT6, _("WxEdit6"), wxPoint(205, 5), wxSize(51, 22), 0, wxDefaultValidator, _("WxEdit6"));
	...
	WxEdit7 = new wxTextCtrl(this, ID_WXEDIT7, _("WxEdit7"), wxPoint(51, 5), wxSize(51, 22), 0, wxDefaultValidator, _("WxEdit7"));
	WxBoxSizer8->Add(WxEdit7, 0, wxALIGN_CENTER | wxALL, 5);

	WxStaticText14 = new wxStaticText(this, ID_WXSTATICTEXT14, _("Krok y"), wxPoint(112, 6), wxDefaultSize, 0, _("WxStaticText14"));
	WxBoxSizer8->Add(WxStaticText14, 0, wxALIGN_CENTER | wxALL, 5);

	WxEdit8 = new wxTextCtrl(this, ID_WXEDIT8, _("WxEdit8"), wxPoint(159, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit8"));
	WxBoxSizer8->Add(WxEdit8, 0, wxALIGN_CENTER | wxALL, 5);

	WxStaticText15 = new wxStaticText(this, ID_WXSTATICTEXT15, _("Krok z"), wxPoint(221, 6), wxDefaultSize, 0, _("WxStaticText15"));
	WxBoxSizer8->Add(WxStaticText15, 0, wxALIGN_CENTER | wxALL, 5);

	WxEdit9 = new wxTextCtrl(this, ID_WXEDIT9, _("WxEdit9"), wxPoint(267, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit9"));
	...
	WxEdit10 = new wxTextCtrl(this, ID_WXEDIT10, _("WxEdit10"), wxPoint(165, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit10"));
	WxBoxSizer9->Add(WxEdit10, 0, wxALIGN_CENTER | wxALL, 5);

	WxEdit11 = new wxTextCtrl(this, ID_WXEDIT11, _("WxEdit11"), wxPoint(227, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit11"));
	WxBoxSizer9->Add(WxEdit11, 0, wxALIGN_CENTER | wxALL, 5);

	WxEdit12 = new wxTextCtrl(this, ID_WXEDIT12, _("WxEdit12"), wxPoint(289, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit12"));
	...
	WxScrollBar4 = new wxScrollBar(this, ID_WXSCROLLBAR4, wxPoint(88, 5), wxSize(140, 18), wxSB_HORIZONTAL, wxDefaultValidator, _("WxScrollBar4"));
	WxScrollBar4->Enable(false);
	WxBoxSizer10->Add(WxScrollBar4, 0, wxALIGN_CENTER | wxALL, 5);

	WxStaticText18 = new wxStaticText(this, ID_WXSTATICTEXT18, _("WxStaticText18"), wxPoint(238, 5), wxDefaultSize, 0, _("WxStaticText18"));
	...
	WxCheckBox3 = new wxCheckBox(this, ID_WXCHECKBOX3, _("Plaszczyzna"), wxPoint(5, 6), wxSize(112, 20), 0, wxDefaultValidator, _("WxCheckBox3"));
	...
	WxEdit13 = new wxTextCtrl(this, ID_WXEDIT13, _("WxEdit13"), wxPoint(149, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit13"));
	...
	WxEdit14 = new wxTextCtrl(this, ID_WXEDIT14, _("WxEdit14"), wxPoint(232, 5), wxSize(52, 22), 0, wxDefaultValidator, _("WxEdit14"));
