...
void PolaWektoroweFrm::CreateGUIControls()
{
	...
	PicPlace = new wxPanel(this, ID_PICPLACE, wxPoint(5, 5), wxSize(161, 36));
	...
	WxToggleButton1 = new wxToggleButton(this, ID_WXTOGGLEBUTTON1, _("1"), wxPoint(10, 20), wxSize(24, 25), 0, wxDefaultValidator, _("WxToggleButton1"));
	WxStaticBoxSizer1->Add(WxToggleButton1, 0, wxALIGN_CENTER | wxALL, 5);

	WxToggleButton2 = new wxToggleButton(this, ID_WXTOGGLEBUTTON2, _("2"), wxPoint(44, 20), wxSize(25, 25), 0, wxDefaultValidator, _("WxToggleButton2"));
	WxStaticBoxSizer1->Add(WxToggleButton2, 0, wxALIGN_CENTER | wxALL, 5);

	WxToggleButton3 = new wxToggleButton(this, ID_WXTOGGLEBUTTON3, _("3"), wxPoint(79, 20), wxSize(26, 25), 0, wxDefaultValidator, _("WxToggleButton3"));
	...
	WxEdit3 = new wxTextCtrl(this, ID_WXEDIT3, _("0.0"), wxPoint(192, 5), wxSize(44, 19), 0, wxDefaultValidator, _("WxEdit3"));
	...
	WxEdit6 = new wxTextCtrl(this, ID_WXEDIT6, _("100.0"), wxPoint(192, 5), wxSize(44, 19), 0, wxDefaultValidator, _("WxEdit6"));
	...
	WxEdit11 = new wxTextCtrl(this, ID_WXEDIT11, _("1.0"), wxPoint(206, 5), wxSize(45, 19), 0, wxDefaultValidator, _("WxEdit11"));
	WxBoxSizer9->Add(WxEdit11, 0, wxALIGN_CENTER | wxALL, 5);

	WxEdit12 = new wxTextCtrl(this, ID_WXEDIT12, _("1.0"), wxPoint(261, 5), wxSize(46, 19), 0, wxDefaultValidator, _("WxEdit12"));
	...
	WxCheckBox3 = new wxCheckBox(this, ID_WXCHECKBOX3, _("Plaszczyzna"), wxPoint(5, 5), wxSize(97, 18), 0, wxDefaultValidator, _("WxCheckBox3"));
	...
	WxStaticText22 = new wxStaticText(this, ID_WXSTATICTEXT22, _("Wybrana funkcja"), wxPoint(150, 24), wxDefaultSize, 0, _("WxStaticText22"));
        ...
        for(double j=wxAtod(WxEdit2->GetValue());j<=wxAtod(WxEdit5->GetValue());j=j+wxAtod(WxEdit8->GetValue())){
            for(double k=wxAtod(WxEdit3->GetValue());k<=wxAtod(WxEdit6->GetValue());k=k+wxAtod(WxEdit9->GetValue())){
                ...
                if(WxToggleButton2->GetValue()){
                    boomLine(dc,Vector3d(i,j,k,2*i,2*j,2*k),255,0,0,mat);
                }
