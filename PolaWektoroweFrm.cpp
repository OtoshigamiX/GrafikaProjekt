...
void PolaWektoroweFrm::CreateGUIControls()
{
	...
	PicPlace = new wxPanel(this, ID_PICPLACE, wxPoint(5, 5), wxSize(500, 300));
	...
	WxToggleButton1 = new wxToggleButton(this, ID_WXTOGGLEBUTTON1, _("1"), wxPoint(10, 20), wxSize(26, 29), 0, wxDefaultValidator, _("WxToggleButton1"));
	WxStaticBoxSizer1->Add(WxToggleButton1, 0, wxALIGN_CENTER | wxALL, 5);

	WxToggleButton2 = new wxToggleButton(this, ID_WXTOGGLEBUTTON2, _("2"), wxPoint(46, 20), wxSize(28, 29), 0, wxDefaultValidator, _("WxToggleButton2"));
	WxStaticBoxSizer1->Add(WxToggleButton2, 0, wxALIGN_CENTER | wxALL, 5);

	WxToggleButton3 = new wxToggleButton(this, ID_WXTOGGLEBUTTON3, _("3"), wxPoint(84, 20), wxSize(30, 29), 0, wxDefaultValidator, _("WxToggleButton3"));
	WxStaticBoxSizer1->Add(WxToggleButton3, 0, wxALIGN_CENTER | wxALL, 5);

	WxToggleButton4 = new wxToggleButton(this, ID_WXTOGGLEBUTTON4, _("4"), wxPoint(124, 20), wxSize(28, 29), 0, wxDefaultValidator, _("WxToggleButton4"));
	...
	WxEdit3 = new wxTextCtrl(this, ID_WXEDIT3, _("0.0"), wxPoint(205, 5), wxSize(49, 22), 0, wxDefaultValidator, _("WxEdit3"));
	...
	WxEdit6 = new wxTextCtrl(this, ID_WXEDIT6, _("100.0"), wxPoint(205, 5), wxSize(49, 22), 0, wxDefaultValidator, _("WxEdit6"));
            ...
            for(double k=StartZ; k<ZakresZ;k+=KrokZ){
                ...
                if(WxToggleButton1->GetValue()){
                    if(WxCheckBox2->GetValue()){
                        boomLine(dc,Vector3d(i,j,k,wxAtod(WxEdit10->GetValue())*i,wxAtod(WxEdit11->GetValue())*j,(wxAtod(WxEdit12->GetValue())*i)).normalize(),255,0,0,mat);
                    }else{
